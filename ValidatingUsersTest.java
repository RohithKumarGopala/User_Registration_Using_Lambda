...
public class ValidatingUsersTest {
    @Test
    public void givenFirstName_IfCorrect_ShouldReturnTrue(){
    ...
    @Test
    public void givenLastName_IfCorrect_ShouldReturnTrue() {
        Pattern pattern = Pattern.compile("([A-Z][a-z]{2,})");
    ...
    @Test
    public void givenEmailId_IfCorrect_ShouldReturnTrue() {
    ...
    @Test
    public void givenMobileNo_IfCorrect_ShouldReturnTrue() {
